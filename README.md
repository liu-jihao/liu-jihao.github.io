...
`mmp`, `gpairs`, `fol`, `sing`, `fano`, `bdd`, `explicit`, `surf`, `generalag`, `groups`, `comb`, `danus`) and rerun. Algebraic geometry that fits nowhere else goes under `generalag`; work outside algebraic geometry gets its own field.
